...
# Form implementation generated from reading ui file 'SaveAsResolution.ui'
#
...
class Ui_SaveAsResolution(object):
    def setupUi(self, SaveAsResolution):
        ...
        SaveAsResolution.resize(500, 150)
        SaveAsResolution.setMinimumSize(QtCore.QSize(500, 150))
        SaveAsResolution.setMaximumSize(QtCore.QSize(500, 150))
        self.horizontalLayoutWidget = QtGui.QWidget(SaveAsResolution)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 110, 481, 31))
        ...
        self.groupBox_SaveAs.setGeometry(QtCore.QRect(10, 10, 481, 101))
        ...
        self.label_filePath = QtGui.QLabel(self.groupBox_SaveAs)
        self.label_filePath.setGeometry(QtCore.QRect(10, 50, 461, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setWeight(50)
        font.setItalic(True)
        ...
        self.label_workArea.setGeometry(QtCore.QRect(10, 70, 461, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setWeight(50)
        font.setItalic(True)
    ...
    def retranslateUi(self, SaveAsResolution):
        ...
        self.label_filePath.setToolTip(QtGui.QApplication.translate("SaveAsResolution", "<html><head/><body><p>This is your current workarea. <span style=\" color:#ff0000;\">Change it if it is not correct!</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.label_filePath.setText(QtGui.QApplication.translate("SaveAsResolution", "path", None, QtGui.QApplication.UnicodeUTF8))
